...
//		@FindBy(xpath="//span[contains(text(),'Hotels')]") WebElement hotel;
//		public void hotel_tab(){ 
//			hotel.click();
//		}
//		
//	    @FindBy(xpath="(//input[@name='q'])[3]") WebElement where;	
//		public void where_input(){ 
//			where.click();
//			where.sendKeys("Switzerland");
//		}
//		
//		@FindBy(xpath="//div[@id='typeahead_results']/a/div[2]/div") WebElement swiss_europe;	
//		public void swiss_europe(){ 
//			swiss_europe.click();
//		}
//		
//		@FindBy (xpath = "//div[2]/div[2]/div[3]/div[2]/div[2]") WebElement checkin;
//		
//		public void checkin() {
//			checkin.click();
//		}
//		
//@FindBy (xpath = "//div[2]/div/div[3]/div[2]/div[4]") WebElement checkout;
//		
//		public void checkout() {
//			checkin.click();
//		}
//		
//@FindBy (xpath = "//div[2]/div/div[2]/div/div/div/button[2]") WebElement increase;
//		
